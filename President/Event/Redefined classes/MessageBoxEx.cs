...
namespace Module_Event
{
    public static class MessageBoxEx
    {
        ...
        public static IWin32Window OwnerMain;

        public static DialogResult Show(string text)
        {
            //AlertForm alertForm = new AlertForm(text);
            //alertForm.Show(OwnerMain);
        ...
        {
            //AlertForm alertForm = new AlertForm(text, size);
            //alertForm.Show(OwnerMain);

            Initialize();
            return MessageBox.Show(OwnerMain, text, caption);
        }
