...
namespace Module_Work
{
    class Profession_Military : IProfession
    {
        ...
        public Profession_Military()
        {
            ...
            {
                new Basic_Work("Военнослужащий", 100, 8, 0, 0, 0),
                new Basic_Work("Конвоир", 100, 8, 0, 0, 0),
                new Basic_Work("Пожарный", 100, 8, 0, 0, 0),
                new Basic_Work("Разведчик", 100, 8, 0, 0, 0),
                new Basic_Work("Спасатель", 100, 8, 0, 0, 0),
                new Basic_Work("Телохранитель", 100, 8, 0, 0, 0),
            };
        }
